package com.xkumo.xstock.service;
...
public class StockService {
     ...
     */
    public SinaDailyStockDataDo getStockRecord(String stockcode, String dayFormat, Connection connection) throws SQLException
    {
		// TODO Auto-generated method stub

		StringBuilder sql = new StringBuilder();
        sql.append("select * from StockDataSina t where StockCode='"+stockcode+"' and DataDay='"+dayFormat+"'");
     ...
     * @throws java.sql.SQLException
     */
    public String getStockPrice(String stockcode, String dayFormatString,   Connection connection) throws SQLException
    {
        StringBuilder sql = new StringBuilder();
        sql.append("select * from StockDataSina t where StockCode='"+stockcode+"' and DataDay='"+dayFormatString+"'");
        ...
        try
	    {
	        ...
	        while (resultSet.next())
	        {
	        	return resultSet.getString("currentprice");
	        }
	    }finally
	    {
	    	try
	 ...
	 * @throws
	 */
	public boolean isStockMarketClosed(String dayFormatString, Connection connection) throws Exception
	{
